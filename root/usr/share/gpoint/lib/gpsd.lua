...
function gpsd.getAllData(modemConfig)
    ...
    if gnssReq == nil and gnssReq.tpv == nil and gnssReq.sky == nil and gnssReq.sky[1] == nil
            and gnssReq.tpv[1] == nil and gnssReq.tpv[1].mode == nil or gnssReq.tpv[1].mode == 1 then
